...
<div class="card">
    <form method="GET" action="{{ route('admin.exams.index') }}" class="search-filter-bar">
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <div style="display: inline-flex; gap: 4px; flex-wrap: wrap; justify-content: center;">
                                <a href="{{ route('admin.exams.show', $ex->id) }}" class="btn btn-sm btn-primary" title="Kelola Soal & Peserta">Detail</a>
                                <a href="{{ route('admin.exams.edit', $ex->id) }}" class="btn btn-sm btn-secondary">Edit</a>
                                <form method="POST" action="{{ route('admin.exams.destroy', $ex->id) }}" onsubmit="return confirm('Apakah Anda yakin ingin menghapus paket ujian ini?');" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
                ...
                @empty
                    <tr>
                        <td colspan="7" class="empty-state">
                            ...
                            <div class="empty-title">Belum ada paket ujian</div>

...
@section('title', 'Telemetri Live: ' . $exam->title . ' - CBT Administrator')
...
<div class="content-header">
    ...
    <div style="display: flex; gap: 8px; align-items: center;">
        ...
        <a href="{{ route('admin.monitoring.index') }}" class="btn btn-secondary btn-sm">&larr; Semua Ujian</a>
    </div>
</div>
...
<div class="card">
    <form method="GET" action="{{ route('admin.monitoring.show', $exam->id) }}" class="search-filter-bar">
        ...
        @if(request('search') || request('class_id'))
            <a href="{{ route('admin.monitoring.show', $exam->id) }}" class="btn btn-secondary">Reset</a>
        @endif
    </form>

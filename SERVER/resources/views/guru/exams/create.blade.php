...
@section('title', 'Buat Paket Ujian - CBT Guru')
...
<div class="content-header">
    ...
    <a href="{{ route('guru.exams.index') }}" class="btn btn-secondary">&larr; Kembali ke Daftar Ujian</a>
</div>
    ...
    <form method="POST" action="{{ route('guru.exams.store') }}">
        ...
        <div class="form-row">
            <div class="form-group" style="flex: 2;">
                ...
                <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" placeholder="Contoh: Penilaian Harian Matematika" value="{{ old('title') }}" required>
                @error('title')
        ...
        <div class="form-row" style="margin-top: 16px;">
            ...
            <div class="form-group" style="flex: 1;">
                ...
                <input type="text" name="token" id="token" maxlength="16" class="form-control" placeholder="Contoh: PH12026" style="text-transform: uppercase;" value="{{ old('token') }}">
            </div>
        ...
        <div class="form-group" style="margin-top: 16px;">
            ...
            <textarea name="instructions" id="instructions" class="textarea-control" rows="3" placeholder="Contoh: Berdoalah sebelum mengerjakan. Pilihlah jawaban yang paling tepat.">{{ old('instructions') }}</textarea>
        </div>

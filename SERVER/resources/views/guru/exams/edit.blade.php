...
@section('title', 'Edit Paket Ujian - CBT Guru')
...
<div class="content-header">
    ...
    <a href="{{ route('guru.exams.show', $exam->id) }}" class="btn btn-secondary">&larr; Kembali ke Detail Ujian</a>
</div>

<div class="card">
    <form method="POST" action="{{ route('guru.exams.update', $exam->id) }}">
        @csrf
        @method('PUT')

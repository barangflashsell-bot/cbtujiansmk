...
@section('title', 'Live Monitoring Ujian - CBT Guru')

@section('content')
<div class="content-header">
    <div>
        <h1 class="page-title">Live Monitoring Ujian</h1>
        <p class="page-subtitle">Pantau aktivitas pengerjaan siswa pada paket ujian yang Anda ampu secara real-time</p>
    </div>
...
<div class="card">
    <form method="GET" action="{{ route('guru.monitoring.index') }}" class="search-filter-bar">
        ...
        @if(request('search') || request('status'))
            <a href="{{ route('guru.monitoring.index') }}" class="btn btn-secondary">Reset</a>
        @endif
    </form>
                ...
                @forelse($exams as $idx => $ex)
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <a href="{{ route('guru.monitoring.show', $ex->id) }}" class="btn btn-sm btn-primary">
                                📡 Pantau Live
                            </a>
                        </td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="8" class="empty-state">
                            ...
                            <div class="empty-desc">Paket ujian yang Anda buat akan muncul pada daftar monitoring ini.</div>
                        </td>
                    </tr>
                @endforelse
            </tbody>

...
@section('title', 'Detail Hasil Ujian - CBT Guru')
...
<div class="content-header">
    ...
    <div style="display: flex; gap: 8px;">
        <form method="POST" action="{{ route('guru.results.publish', $result->id) }}" style="display:inline;">
            @csrf
        ...
        <a href="{{ route('guru.results.index') }}" class="btn btn-secondary btn-sm">&larr; Kembali ke Rekap</a>
    </div>
</div>
